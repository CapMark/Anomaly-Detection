...
device = "cuda"
features_path="features\c3d" #sostituire con il path alle features
model_Path="results\model\epoch_40.pt" #sostituire con il modello addestrato sul dataset GIUSTO
data_loader = DataloaderVal(features_path, annotation_path="Test_Annotation.txt") #sostituire con le annotazioni giuste
